...
const CatsController = {
  async searchForBreedByQuery(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getBreedByBreedId(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getImagesOfBreedByBreedId(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getMostPopularBreeds(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
